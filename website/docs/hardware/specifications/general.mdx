...
<BlockImage src="hardware/specification/general/payload1.png" alt="Payload1" width="65%" />
...
<BlockImage src="hardware/specification/general/payload2.png" alt="Payload2" width="65%" />
