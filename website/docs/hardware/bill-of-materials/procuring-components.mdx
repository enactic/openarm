...
- [**Manufactured Components**](/hardware/bill-of-materials/arm-manufactured.mdx): Machined on-demand using MISUMI’s MEVIY service.
...
1. Download the **[Gerber](/files/Gerber_For_Hub.zip) + [BOM](/files/bom-for-hub.csv) + [CPL](/files/CPL_For_Hub.xlsx)** files from the project repository.
...
If you are interested in purchasing motors, please **contact us directly via email** at **[openarm@enactic.ai](mailto:openarm@enactic.ai)**.
We will assist you with pricing, availability, and shipping details.
