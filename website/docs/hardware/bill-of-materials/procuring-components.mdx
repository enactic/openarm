...
- **Off-the-shelf Components**: Standard items with a part number.
- **Manufactured Components**: Machined on-demand using MISUMI’s MEVIY service.
...
This project uses a mix of off-the-shelf electronic modules and custom PCBs and wiring harnesses. Below are recommendations on how to procure them.
...
> 🔍 Tip: Always check product ratings, reviews, and delivery estimates. Buy a few spares for time-sensitive builds.
...
1. Download the **[Gerber](/files/Gerber_For_Hub.zip) + [BOM](/files/BOM_For_Hub.csv) + [CPL](/files/CPL_For_Hub.xlsx)** files from the project repository.
...
7. Upload the BOM and CPL files, and click on `Process BOM & CPL`.
<BlockImage src="hardware/bom/procurement/jlcpcb-step6.png" alt="jlcpcb-6" width="70%" />
8. Review the parts on the next page and proceed. 
9. Review the 2D and 3D models on the next page and click on `Next`.
<BlockImage src="hardware/bom/procurement/jlcpcb-step7.png" alt="jlcpcb-7" width="70%" />
10. Proceed to place the order.
...
If you are interested in purchasing motors, please **contact us directly via email** at **[openarm@enactic.ai](mailto:openarm@enactic.ai)**. We will assist you with pricing, availability, and shipping details.
