...
import BoMSummaryTable from '@site/src/components/BoMSummaryTable';
...
<h1>
  <strong>The Total BOM Price is ¥ 960,438</strong>
</h1>

<BlockImage src="hardware/bom/procurement/bom-summary.png" alt="meviy" width="70%" />
