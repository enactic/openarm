...
8. Upload the BOM and CPL files, and click on `Process BOM & CPL`.
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td style={{ textAlign: 'center' }}><code>{ formatPrice(ArmManufacturedTotalCost()) }</code></td>
    </tr>
    <tr>
      <td style={{ textAlign: 'center' }}>Off-the-shelf Arm Parts</td>
      <td style={{ textAlign: 'center' }}><a href="arm-off-the-shelf">View Parts</a></td>
      <td style={{ textAlign: 'center' }}><code>{ formatPrice(ArmOffTheShelfTotalCost()) }</code></td>
    </tr>
    <tr>
      <td style={{ textAlign: 'center' }}>Pedestal Components</td>
      <td style={{ textAlign: 'center' }}><a href="pedestal">View Parts</a></td>
      <td style={{ textAlign: 'center' }}><code>{ formatPrice(PedestalManufacturedTotalCost() + PedestalOffTheShelfTotalCost()) }</code></td>
    </tr>
    <tr>
      <td style={{ textAlign: 'center' }}>Gripper Components</td>
      <td style={{ textAlign: 'center' }}><a href="gripper">View Parts</a></td>
      <td style={{ textAlign: 'center' }}><code>{ formatPrice(GripperManufacturedTotalCost() + GripperOffTheShelfTotalCost()) }</code></td>
    </tr>
  </tbody>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td style={{ textAlign: 'center' }}><code>{ formatPrice(ElectricalTotalCost()) }</code></td>
    </tr>
  </tbody>
</table>
