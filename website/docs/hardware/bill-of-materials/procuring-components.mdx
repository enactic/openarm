...
import ActuatorsTable from '@site/src/components/ActuatorsTable';
import MechanicalComponentsTable from '@site/src/components/MechanicalComponentsTable';
import ElectricalComponentsTable from '@site/src/components/ElectricalComponentsTable';
