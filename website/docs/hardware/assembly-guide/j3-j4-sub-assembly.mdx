...
3. Place the `J4_B` on the interior side of `J4_A`,aligning the holes.
...
7. Carefully insert the post `AETTS8-61-SC0-M3-N3` (thread post 61mm) between the flanges of `J4_A` and fasten them with 2 `M3x6` bolts
