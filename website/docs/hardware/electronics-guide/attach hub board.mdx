...
<img
  src="/img/hardware/electronics-guide/hubboard_components.png"
  alt="Hub board components"
  width="80%"
/>
...
<img
  src="/img/hardware/electronics-guide/hubboard_attaching.png"
  alt="hub board attaching"
  width="80%"
/>