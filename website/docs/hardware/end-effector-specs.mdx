...
<BlockImage src="hardware/end-effector/spec.png" alt="spec" width="90%" />
...
<figure style={{ textAlign: 'center' }}>
  <BlockImage src="hardware/end-effector/fullyopen.png" alt="fully open" width="90%" />
...
<figure style={{ textAlign: 'center' }}>
  <BlockImage src="hardware/end-effector/fullyclosed.png" alt="fully closed" width="90%" />
  <figcaption style={{ fontSize: '0.9em', color: '#666', marginTop: '0.5em' }}>
