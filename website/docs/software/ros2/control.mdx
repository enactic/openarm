...
* Edit [~/ros2_ws/src/openarm_description/config/arm/v10/control_gains.yaml](https://github.com/enactic/openarm_description/blob/main/config/arm/v10/control_gains.yaml).
