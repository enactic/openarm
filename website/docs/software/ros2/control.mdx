...
To get started, follow this [Robot Description](../robot_description) guide to install ROS2 first to setup and test the OpenArm description package which you will need for ROS2 control.
