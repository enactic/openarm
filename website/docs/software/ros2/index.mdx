---
description: Robot Operating System 2 Tutorial for OpenArm
---
# ROS2

ROS2 is a framework to manage the complexity of robotics. To get started, install ROS2 by following the official instructions. 

We recommend using [Humble](https://docs.ros.org/en/humble/Installation.html) on Ubuntu 22.04, but other options may work as well. See below for a non-exhaustive list of alternatives.
...
<BlockImage src="software/ros2/bimanual_urdf_rviz.png" alt="Bimanual URDF Rviz" width="95%" />
...
<BlockImage src="software/ros2/single_arm_urdf_rviz.png" alt="Single Arm URDF Rviz" width="95%" />
...
<BlockImage src="software/ros2/bimanual_moveit2.png" alt="MoveIt2 Static" width="95%" />
...
<BlockImage src="software/ros2/bimanual_moveit2_planning.png" alt="MoveIt2 Planning" width="95%" />
...
### Distrobox (Linux)
On other distributions of Linux, [distrobox](https://distrobox.it/) allows for the use of other distributions through Docker or Podman.
