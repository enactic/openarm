...
<BlockImage src="getting-started/safety-guidelines/leader-follower1.png" alt="Unilateral leader-follower control" width="100%" />
...
<BlockImage src="teleop/4ch_bilateral.png" alt="Bilateral control diagram" width="40%" />