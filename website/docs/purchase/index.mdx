...
<div style={{ overflowX: 'auto', marginTop: '3rem' }}>
  ...
  | Anvil Robotics (Taipei)                                    | Ships within 48 hours | Worldwide      | $5,600 (V2)         | Not evaluated                                           | [**Accepting orders** (website)](https://shop.anvil.bot/collections/all)<br />OpenArm 2.0 full devkits in stock, shipped within 48 hours. OpenArm 1.0 deprecated.<br />Discord: `@mike[at]anvil.bot`                                  |
