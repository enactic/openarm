...
<div style={{ overflowX: 'auto', marginTop: '3rem' }}>
  ...
  | Cereboto (Dongguan)           | 20 days             | Worldwide           | $5,000             | Evaluating...   | [**Accepting orders** (website)](https://cereboto.com/product/openarm/) [(taobao)](https://item.taobao.com/item.htm?abbucket=19&id=985310497224&mi_id=0000maNeUVkMecQWeJExceolALadkcyEc3REhg1Dd-rBpVg&ns=1&skuId=6114365243418&utparam=%7B"aplus_abtest":"8a8f9036f16e4ae427a8d0a642cd9f1b"%7D&xxc=taobaoSearch)<div>Discord: `@chuck.yu`</div><div>WeChat: `U_Charles`</div><div>Email: `chuck.yu@cereboto.com`</div> |
  ...
  | Chengdu Changshu Robotics Co., Ltd.| 7 - 28 days    | Worldwide           | $4,999             | Not evaluated   | [**Accepting orders** (website)](https://www.openarmx.com)<div>Discord: `@PowerZ`</div><div>WeChat: `alwaysklose`</div><div>⚠️ “OpenArmX Pro Max” is **NOT** affiliated with or compatible with the official OpenArm project at the moment.</div>|
</div>
