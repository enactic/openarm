  ...
  <div style={{
    ...
    <div style={{
      ...
      <div style={{ marginTop: '0.75rem' }}>
        <strong>Now shipping OpenArm 2</strong> — the latest bimanual platform with 7 DoF per arm, in-hand cameras, and 1 kHz CAN-FD real-time control. A V1 -> V2 upgrade kit is also available for existing OpenArm V1 owners.
      </div>
      <div style={{ marginTop: '0.5rem' }}>
        <strong>OpenArm Cell Modular Kit</strong> {'(from $6,200)'} — a standardized workspace cell for reproducible embodied AI experiments. Includes a MISUMI-frame enclosure (1100 × 926 × 1883 mm), a 300 mm Z-axis, a top stereo camera, and controlled lighting. Shipped in modular sections for easier international delivery.
      </div>
    </div>
    <a
      href="https://shop.wowrobo.com/collections/openarm"
...
<div style={{ overflowX: 'auto', marginTop: '3rem' }}>
  ...
  | Cereboto (Dongguan)                                        | 20 days              | Worldwide       | $5,000              | Evaluating...                                           | [**Accepting orders** (website)](https://cereboto.com/product/openarm/) [(taobao)](https://item.taobao.com/item.htm?id=985310497224)<br />Discord: `@chuck.yu`<br />WeChat: `U_Charles`<br />Email: `chuck.yu@cereboto.com`   |
