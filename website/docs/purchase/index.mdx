    ...
    <div style={{
      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{ fontWeight: '600' }}>Setup & testing, JP-spec AC adapter, optional 1-yr warranty</div>
        </div>
        <div>
...
<div style={{
  ...
  <div style={{
    ...
    <div style={{
      ...
      <div>
        <a
          href="https://shop.wowrobo.com/products/openarm-ker"
          target="_blank"
          rel="noopener noreferrer"
        >
          <img
            src={require("@site/static/img/purchase/wowrobo-openarm-ker.png").default}
            alt="OpenArm KER by WowRobo"
            style={{
              width: '100%',
              borderRadius: '0.75rem',
              boxShadow: '0 2px 8px rgba(0,0,0,0.1)',
        ...
        <div style={{ marginTop: '0.5rem', textAlign: 'center', fontSize: '0.9rem' }}>
          <div style={{ fontWeight: '600', color: '#111827' }}>OpenArm KER</div>
          <div style={{ color: '#6b7280' }}>{'from $2,599'}</div>
        </div>
      </div>
    </div>
    <div style={{
      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{ fontWeight: '600' }}>{'$2,599 (KER)'}</div>
          <div style={{ fontWeight: '600' }}>{'$49 (KER Encoder Unit)'}</div>
        </div>
        <div>
          <div style={{ color: '#6b7280' }}>⏱️ Lead Time (Order→Ship)</div>
    ...
    <div style={{
      ...
      <strong>OpenArm KER (Kinematic Equivalent Replica)</strong>:
      <div style={{ marginTop: '0.5rem' }}>
...
<div style={{ overflowX: 'auto', marginTop: '3rem' }}>
  ...
  |------------------------------------------------------------|----------------------|-----------------|---------------------|---------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
  | **WowRobo** (ShenZhen)                                     | 20-40 days           | Worldwide       | \$5,400 (V1.1) / \$6,500 (V2) / \$6,200 (Cell) / \$2,599 (KER) / \$49 (KER Encoder Unit) | Certified <span style={{ color: 'orange' }}>★★★</span> | [**Accepting orders** (website)](https://shop.wowrobo.com/collections/openarm)<br />V1.1, V2, V1 -> V2 upgrade kit, OpenArm Cell modular kit, [OpenArm KER](https://shop.wowrobo.com/products/openarm-ker), and [KER Encoder Unit](https://shop.wowrobo.com/products/ker-encoder-unit) available.<br />Discord: `@Leo Xiao @WowRobo`<br />Wechat: `xiaonian52`<br />Email: `leo.xiao@wowrobo.com` |
