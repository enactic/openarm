...
<div style={{ overflowX: 'auto', marginTop: '3rem' }}>
  ...
  |------------------------------------------------------------|----------------------|-----------------|---------------------|---------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
  | **WowRobo** (ShenZhen)                                     | 20-40 days           | Worldwide       | $5,000              | Certified <span style={{ color: 'orange' }}>★★★</span> | [**Accepting orders** (website)](https://shop.wowrobo.com/products/openarm-open-source-humanoid-robot-arm-by-enactic)<br />Discord: `@Leo Xiao @WowRobo`<br />Wechat: `xiaonian52`<br />Email: `leo.xiao@wowrobo.com`       |
  | **RT Corporation** (Tokyo)                                 | -                    | Japan           | -                   | Evaluating...                                           | Not yet accepting orders.                                                                                                                                                                                                   |
  | VLAI Robotics (ShenZhen)                                   | 35 days              | Worldwide       | $5,400              | Evaluating...                                           | [**Accepting bulk orders** (email)](mailto:contact@vlai.cn)<br />Discord: `@VLAIZhang`<br />WeChat: `VLAIBOT`                                                                                                               |
  ...
  | Anvil Robotics (Taipei)                                    | 28 days              | Worldwide       | $5,800              | Not evaluated                                           | [**Accepting orders** (website)](https://shop.anvil.bot/collections/all)<br />Discord: `@mike[at]anvil.bot`                                                                                                                        |
