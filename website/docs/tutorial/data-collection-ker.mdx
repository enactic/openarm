...
3. Attach the holder to to the mounting plate. Make sure the holder is securely attached. 
...
KER M5 link:
{/* TODO: add the link to the KER M5Stack firmware repository */}
...
{/*
TODO: add the link to the zero position calibration guide in the hardware section
*/}
...
encoder module link : 
{/*
TODO: add the link to the encoder module firmware repository
*/}
