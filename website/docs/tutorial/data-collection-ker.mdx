...
<BlockImage src="tutorial/data-collection-ker/attachment.png" alt="attachment" width="90%" />
...
<BlockImage src="tutorial/data-collection-ker/trouble.png" alt="error display" width="90%" />
...
<BlockImage src="tutorial/data-collection-ker/encoder_connection.jpg" alt="encoder connection" width="90%" />
