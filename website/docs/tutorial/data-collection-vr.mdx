...
1. Put on the headset and launch the teleoperation app. After the app is launched, you should see the following screen in the headset.
   <BlockImage src="tutorial/data-collection-vr/in_vr_default.jpg" alt="Quest headset" width="90%" />

2. Press the left controller menu button — a settings panel will appear.
   <BlockImage src="tutorial/data-collection-vr/in_vr_setting.png" alt="VR menu" width="90%" />
...
5. Tape the center-of-eye sensor on the headset to keep it constantly activated (prevents the display from sleeping when worn at the neck).
   ...
   <BlockImage src="tutorial/data-collection-vr/headset_uncover.png" alt="Headset sensor uncovered" width="90%" />

   After taping the sensor:
   <BlockImage src="tutorial/data-collection-vr/headset_covered.png" alt="Headset sensor covered" width="90%" />

6. Take off the headset and hang it around your neck — you will operate with the controllers while the headset rests there.
   <BlockImage src="tutorial/data-collection-vr/how_to_wear_headset.png" alt="Headset around neck" width="90%" />
...
<BlockImage src="tutorial/data-collection-vr/mujoco_datacollection.gif" alt="MuJoCo teleoperation" />
...
<BlockImage src="tutorial/data-collection-vr/quest_controller_right.jpg" alt="Controller button" width="40%" />
...
<BlockImage src="tutorial/data-collection-vr/data_collection_start_quit.png" alt="UI top" width="80%" />
...
<BlockImage src="tutorial/data-collection-vr/data_collection_success_fail.png" alt="UI recording" width="80%" />
