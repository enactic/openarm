...
# Data collection with VR teleoperation
...
Download the [teleoperation APK](https://drive.google.com/file/d/1lLDuoQAcl3YBKPE77F_1Z-8RzXEOFxpm/view?usp=drive_link).
...
1. Put on the headset and launch the teleoperation app. After the app is launched, you should see the following screen in the headset.
   <BlockImage src="tutorial/data-collection-vr/in-vr-default.jpg" alt="Quest headset" width="90%" />

2. Press the left controller menu button — a settings panel will appear.
   <BlockImage src="tutorial/data-collection-vr/in-vr-setting.png" alt="VR menu" width="90%" />
...
5. Tape the center-of-eye sensor on the headset to keep it constantly activated (prevents the display from sleeping when worn at the neck).
   ...
   <BlockImage src="tutorial/data-collection-vr/headset-uncover.png" alt="Headset sensor uncovered" width="90%" />

   After taping the sensor:
   <BlockImage src="tutorial/data-collection-vr/headset-covered.png" alt="Headset sensor covered" width="90%" />

6. Take off the headset and hang it around your neck — you will operate with the controllers while the headset rests there.
   <BlockImage src="tutorial/data-collection-vr/how-to-wear-headset.png" alt="Headset around neck" width="90%" />
...
To collect data in MuJoCo, use the same dataflow.
...
Default data path can be found in `dataflow-vr-mujoco.yaml` `DIRECTORY: "vr_mujoco_data"`.
...
:::info
If you want to teleoperate **OpenArm 2.0 alone without the cell**, please move on to the next section.
:::
...
If you have the OpenArm 2.0 alone without the cell, you can still collect data with VR teleoperation.
...
AOnce the alignment completes, you can fully control the arm with the VR controllers.
...
<BlockVideo src="tutorial/pedestal_mujoco.mp4" width="80%"/>
