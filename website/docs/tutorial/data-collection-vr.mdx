...
:::info
If you want to teleoperate **OpenArm 2.0 alone without the cell**, please see [Data collection on the real robot (pedestal)](../tutorial/data-collection-webxr.mdx#data-collection-on-the-real-robot-pedestal).
:::
