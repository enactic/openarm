...
For detailed usage, see [CAN CLI Reference change_baud](../../api-reference/can/cli#change_baud--change-motor-baudrate).
...
For detailed usage, see [CAN CLI Reference monitor](../../api-reference/can/cli#monitor--live-telemetry-dashboard).
