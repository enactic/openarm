...
[KER M5Stack firmware](https://github.com/enactic/openarm_ker_firmware/tree/main/M5)
...
<BlockImage src="apiref/setup_ker/ker_id.png" alt="encoder connection" width="90%" />
### Optional
