...
:::warning
* The Damiao Debugging Tool communicates via **serial (UART)**, not CAN.
* The serial connection runs at **921600 bps**.
:::
...
* If the motor starts but fails to rotate: Check the current provided and compare if you're supplying enough with this [table below](#recommended-currents)
...
| Motor     | Minimum Current | Recommended Current |
|-----------|-----------------|---------------------|
